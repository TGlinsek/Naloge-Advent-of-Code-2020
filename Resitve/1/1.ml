...
let ime_repozitorija = "Naloge-Advent-of-Code-2020";;


let vstopi_v_pravi_direktorij dan = (
    if (Sys.getcwd() <> ime_repozitorija) then 
        Sys.chdir ime_repozitorija;;
) *)
(* izraza za "then" in za "else" morata biti enakega tipa *)
